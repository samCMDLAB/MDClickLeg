...
url = "https://mgaleg.maryland.gov/mgawebsite/Members/Index/senate/name"
...
with open('maryland_senate_members.json', 'w') as json_file:
    json.dump(members_data, json_file, indent=4)

print("Data saved to maryland_senate_members.json")
